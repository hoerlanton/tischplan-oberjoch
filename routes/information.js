...
module.exports = {
    getInformation: function (req, res, db) {
        ...
        db.oberjochNewInformation.find(function (err, information) {
            if (err) {
                res.send(err);
            }
    ...
    deleteInformation: function (req, res, db) {
        ...
        db.oberjochNewInformation.remove({
    ...
    newInformationToBox: function (req, res, db) {
        ...
        console.log(req.body);
        let newInformation = req.body;
        db.oberjochNewInformation.save(newInformation, function (err, newInformation) {
            if (err) {
                res.send(err);
            }
